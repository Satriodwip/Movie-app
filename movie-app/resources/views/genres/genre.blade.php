            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
                    ...
                    <div class="col-span-2 flex items-center">
                        ...
                        <p class="text-sm m-3 font-medium text-black dark:text-white">
                            Noragami
                        </p>
                    </div>
                    <div class="col-span-4 flex items-center">
                ...
                <div class="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
                    ...
                    <div class="col-span-4 flex items-center">
                        <p class="text-sm font-medium text-black dark:text-white">
                        The story of an office worker who was stabbed by a criminal as a result of helping someone he was killed and incarnated into a slime he was in his second life he aspired to build a country that was peaceful and comfortable for any race to live in without any discrimination.
                        </p>
                    </div>
                    <div class="col-span-1 flex items-center">
                        <div class="flex items-center space-x-1">
